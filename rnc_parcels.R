...
leaflet() %>% 
  ...
  addPolygons(data = rnc_parcels, weight = 2, color = "lightslateblue", label = ~paste0("Owner: ", owner_9b), highlight = highlightOptions(weight = 3,color = "red",bringToFront = FALSE), group = "Parcels", opacity = .75) %>% 
