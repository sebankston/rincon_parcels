...
leaflet() %>% 
  ...
  addPolygons(data = rnc_parcels, weight = 1.5, color = "lawngreen", label = ~paste0("Owner: ", owner_9b), highlight = highlightOptions(weight = 3,color = "red",bringToFront = TRUE), group = "Parcels") %>% 
